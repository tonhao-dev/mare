...
import { updateControl } from "@/app/controls/actions";
...
export function EditControlForm({ id, defaultValues }: EditControlFormProps) {
  ...
  function onSubmit(data: ControlFormValues) {
    ...
    startTransition(async () => {
      const result = await updateControl(id, data);
